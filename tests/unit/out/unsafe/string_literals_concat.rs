...
unsafe fn main_0() -> i32 {
    ...
    assert!((((*split_pieces.offset((0) as isize)) as i32) == (('a' as core::ffi::c_char) as i32)));
    assert!((((*split_pieces.offset((3) as isize)) as i32) == (('d' as core::ffi::c_char) as i32)));
    assert!((((*split_pieces.offset((6) as isize)) as i32) == (('g' as core::ffi::c_char) as i32)));
    assert!((((*split_pieces.offset((8) as isize)) as i32) == (('i' as core::ffi::c_char) as i32)));
    assert!(
