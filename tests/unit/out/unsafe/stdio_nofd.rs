...
pub unsafe fn test_fgets_getc_2() {
    ...
    assert!((((!((fp).is_null())) as i32) != 0));
    assert!(
        ((((libc::fputs(((c"line1\nline2\n".as_ptr().cast_mut()).cast_const()), (fp))) >= (0))
            as i32)
            != 0)
    );
    assert!(((((libc::fclose((fp))) == (0)) as i32) != 0));
...
pub unsafe fn test_fseeko_4() {
    ...
    assert!((((!((fp).is_null())) as i32) != 0));
    assert!(
        ((((libc::fputs(((c"hello world".as_ptr().cast_mut()).cast_const()), (fp))) >= (0))
            as i32)
            != 0)
    );
    assert!(((((libc::fclose((fp))) == (0)) as i32) != 0));
    ...
    assert!((((!((fp).is_null())) as i32) != 0));
    assert!(
        ((((libc::fseeko((fp), (6_i64) as ::libc::off_t, (::libc::SEEK_SET))) == (0)) as i32) != 0)
    );
    let mut buf: [libc::c_char; 8] = [
        (0 as libc::c_char),
        (0 as libc::c_char),
    ...
    assert!(
        ((((libc::fseeko((fp), (-5_i32 as i64) as ::libc::off_t, (::libc::SEEK_END))) == (0))
            as i32)
            != 0)
    );
    assert!(((((libc::fgetc((fp))) == ('w' as i32)) as i32) != 0));
    assert!(
        ((((libc::fseeko((fp), (1_i64) as ::libc::off_t, (::libc::SEEK_CUR))) == (0)) as i32) != 0)
    );
...
pub unsafe fn test_rename_5() {
    ...
    assert!((((!((fp).is_null())) as i32) != 0));
    assert!(
        ((((libc::fputs(((c"data".as_ptr().cast_mut()).cast_const()), (fp))) >= (0)) as i32) != 0)
    );
    assert!(((((libc::fclose((fp))) == (0)) as i32) != 0));
    assert!(((((libc::rename((from), (to))) == (0)) as i32) != 0));
    assert!(
        ((((libc::fopen((from), ((c"rb".as_ptr().cast_mut()).cast_const()))).is_null()) as i32)
            != 0)
    );
...
pub unsafe fn test_setvbuf_6() {
    ...
    assert!(
        ((((libc::fputs(((c"x".as_ptr().cast_mut()).cast_const()), (fp))) >= (0)) as i32) != 0)
    );
    assert!(((((libc::fclose((fp))) == (0)) as i32) != 0));
    assert!(((((libc::unlink((path))) == (0)) as i32) != 0));
}
