...
unsafe fn main_0() -> i32 {
    ...
    (unsafe { set_op_3(Some(double_it_0 as unsafe fn(i32) -> i32)) });
    assert!(!((g_op_2).is_none()));
    assert!(((g_op_2) == (Some(double_it_0 as unsafe fn(i32) -> i32))));
    assert!(((unsafe { call_op_4(5,) }) == (10)));
    (unsafe { set_op_3(Some(triple_it_1 as unsafe fn(i32) -> i32)) });
    assert!(((g_op_2) == (Some(triple_it_1 as unsafe fn(i32) -> i32))));
