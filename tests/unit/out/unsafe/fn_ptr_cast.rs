...
pub unsafe fn test_roundtrip_1() {
    let mut fn_: Option<unsafe fn(i32) -> i32> = Some(double_it_0 as unsafe fn(i32) -> i32);
...
pub unsafe fn test_void_ptr_to_fn_3() {
    ...
    cmd.data = std::mem::transmute::<Option<unsafe fn(i32) -> i32>, *mut ::libc::c_void>(Some(
        double_it_0 as unsafe fn(i32) -> i32,
    ));
...
pub unsafe fn test_call_through_cast_5() {
    let mut gfn: Option<unsafe fn(*mut ::libc::c_void, i32) -> i32> =
        ...
        >(Some(add_offset_4 as unsafe fn(*mut i32, i32) -> i32));
    let mut val: i32 = 100;
