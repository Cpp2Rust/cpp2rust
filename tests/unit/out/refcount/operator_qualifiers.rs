...
fn main_0() -> i32 {
    ...
    assert!((({ SImpl::operator_add_i32(&vs.as_pointer(), 1,) }) == 13));
    assert!((({ SImpl::operator_sub_i32(&s.as_pointer(), 1,) }) == 9));
    assert!(
        (({
            SImpl::operator_sub_i32(
                &S {
                    v: Rc::new(RefCell::new(10)),
                },
                1,
    ...
    assert!((({ SImpl::operator_mul_i32_const(&s.as_pointer(), 3,) }) == 30));
    assert!((({ SImpl::operator_mul_i32_const(&cs.as_pointer(), 3,) }) == 30));
    assert!(
        (({
            SImpl::operator_mul_i32_const(
                &S {
                    v: Rc::new(RefCell::new(10)),
                },
                3,
    ...
    assert!((({ SImpl::operator_index_i32(&s.as_pointer(), 2,) }) == 12));
    assert!((({ SImpl::operator_index_i32_const(&cs.as_pointer(), 2,) }) == 112));
    return 0;
}
pub trait SImpl {
    ...
    fn operator_add_i32(&self, a: i32) -> i32;
    fn operator_sub_i32(&self, a: i32) -> i32;
    fn operator_sub_i32(&self, a: i32) -> i32;
    fn operator_mul_i32_const(&self, a: i32) -> i32;
    fn operator_mul_i32_const(&self, a: i32) -> i32;
    fn operator_index_i32(&self, i: i32) -> i32;
    fn operator_index_i32_const(&self, i: i32) -> i32;
}
