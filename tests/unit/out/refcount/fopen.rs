...
fn main_0() -> i32 {
    let fname: Value<Ptr<core::ffi::c_char>> =
        Rc::new(RefCell::new(Ptr::from_string_literal(b"testfile.txt")));
    let mode: Value<Ptr<core::ffi::c_char>> =
        Rc::new(RefCell::new(Ptr::from_string_literal(b"rb")));
