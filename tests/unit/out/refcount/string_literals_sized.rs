...
fn main_0() -> i32 {
    ...
    assert!((((*empty_buf.borrow())[(0) as usize] as i32) == (('\0' as core::ffi::c_char) as i32)));
    assert!(
    ...
    assert!((((*prefix_buf.borrow())[(0) as usize] as i32) == (('%' as core::ffi::c_char) as i32)));
    assert!(
    ...
    assert!((((*short_buf.borrow())[(0) as usize] as i32) == (('h' as core::ffi::c_char) as i32)));
    assert!((((*short_buf.borrow())[(1) as usize] as i32) == (('i' as core::ffi::c_char) as i32)));
    assert!((((*short_buf.borrow())[(2) as usize] as i32) == (('\0' as core::ffi::c_char) as i32)));
    assert!(
    ...
    assert!((((*exact_buf.borrow())[(0) as usize] as i32) == (('h' as core::ffi::c_char) as i32)));
    assert!((((*exact_buf.borrow())[(4) as usize] as i32) == (('o' as core::ffi::c_char) as i32)));
    assert!((((*exact_buf.borrow())[(5) as usize] as i32) == (('\0' as core::ffi::c_char) as i32)));
